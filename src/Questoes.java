...
public class Questoes extends JFrame implements ItemListener, ActionListener {
    ...
    public Questoes(){
        ...
        getContentPane().setBackground(new Color(178,178,255));
            ...
            imagem.setIcon(new ImageIcon("img/Cabra.jpg"));

            pergunta = new JLabel("Qual o animal da imagem?");
            pergunta.setBounds(100, 185, 200, 20);

            alternativa01 = new JRadioButton("Gato");
            ...
            alternativa02 = new JRadioButton("Lemure");
            ...
            alternativa03 = new JRadioButton("Cabra");
            ...
            alternativa04 = new JRadioButton("Lontra");
            ...
            alternativa05 = new JRadioButton("Zebra");
    ...
    public void itemStateChanged(ItemEvent e) {
        ...
        else if(i == 9 && alternativa01.isSelected()){
            acertos++;
        }
        else{
            acertos = acertos;
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if(i == 1) {
            ...
            imagem.setIcon(new ImageIcon("img/Iguana.jpg"));
            alternativa01.setText("Iguana");
            ...
            imagem.setIcon(new ImageIcon("img/Leão.jpg"));
            ...
            imagem.setIcon(new ImageIcon("img/Lontra.jpg"));
            alternativa01.setText("Cabra");
            alternativa02.setText("Lontra");
            alternativa03.setText("Cobra");
            alternativa04.setText("Iguana");
            alternativa05.setText("Cavalo Marinho");
        }
        else if (i == 6){
            imagem.setIcon(new ImageIcon("img/Sapo.jpg"));
            alternativa01.setText("Iguana");
            alternativa02.setText("Cavalo Marinho");
            alternativa03.setText("Tartaruga");
            alternativa04.setText("Sapo");
            ...
            imagem.setIcon(new ImageIcon("img/Zebra.jpg"));
            alternativa01.setText("Iguana");
            alternativa02.setText("Cavalo");
            alternativa03.setText("Cobra");
            alternativa04.setText("Iguana");
